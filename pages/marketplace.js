...
export default function Marketplace() {
  ...
  const VendorCard = ({ vendor }) => (
    <div
      ...
      style={{
        border: `2px solid ${vendor.account_type === "premium" ? "#AABB23" : "#eee"}`,
        borderRadius: 12,
        overflow: "hidden",
        cursor: "pointer",
    ...
    <div style={{ maxWidth: 1000, margin: "0 auto", padding: 20, fontFamily: "sans-serif" }}>
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            padding: "8px 16px", backgroundColor: "#701890", color: "white",
      ...
      {/* BOTTOM BANNER */}
      <div style={{
        marginTop: 40, backgroundColor: "#f9ffe8",
        border: "1px solid #AABB23", borderRadius: 10,
        ...
        <button
          ...
          style={{
            padding: "8px 16px", backgroundColor: "#AABB23", color: "white",
            border: "none", borderRadius: 6, cursor: "pointer",
            fontWeight: "bold", fontSize: 13,
          }}
        >
