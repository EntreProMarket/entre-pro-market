...
import AdminEpmEventsTab from "../components/AdminEpmEventsTab";
import AdminNewsTab from "../components/AdminNewsTab";
import AdminMessagingTab from "../components/AdminMessagingTab";
import AdminBusinessEmailTab from "../components/AdminBusinessEmailTab";
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#f8f9fa", fontFamily: "sans-serif" }}>
      ...
      <div style={{ padding: 24, maxWidth: 1000, margin: "0 auto" }}>
        ...
        {activeTab === "Orders" && <AdminOrdersTab adminId={adminId} />}
        ...
        {activeTab === "EPM Events" && <AdminEpmEventsTab />}

        {activeTab === "Shop" && <AdminShopTab adminId={adminId} />}

        {activeTab === "Community & News" && <AdminNewsTab />}

        {activeTab === "Messaging" && <AdminMessagingTab adminId={adminId} users={users} />}

        {activeTab === "Business Email" && <AdminBusinessEmailTab adminId={adminId} />}
          ...
          <div>
            ...
            <div style={{ backgroundColor: "white", border: "1px solid #eee", borderRadius: 10, padding: 20, marginBottom: 16 }}>
              ...
              <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
                ...
                <button onClick={() => window.open('/epm-shop', '_blank')} style={smallBtnStyle}>EPM Shop</button>
