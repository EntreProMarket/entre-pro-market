...
export default function AdminDashboard() {
  ...
  // ── ORDERS TAB (proof review for CashApp/Venmo manual sales) ──
...
// ── EPM EVENTS (Admin-created, shown mixed with Elite Organizer events on the Homepage) ──
  ...
  // ── ORDERS (proof review for CashApp/Venmo manual sales) ──
        ...
        {activeTab === "Orders" && (
          <div>
            ...
            {loadingOrders ? <p style={{ color: "#888" }}>Loading orders...</p> : (() => {
              ...
              if (filtered.length === 0) return <div style={{ backgroundColor: "white", border: "1px solid #eee", borderRadius: 10, padding: 30, textAlign: "center", color: "#888" }}><p>No orders found.</p></div>;
              return (
