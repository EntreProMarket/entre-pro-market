  ...
  return (
    <div style={{
      ...
      <p style={{ color: "#666", fontSize: 15, maxWidth: 320, lineHeight: 1.6, marginBottom: 32 }}>
        This feature is available to Vendors and Organizers only. Upgrade your account to unlock your Dashboard, Profile, Messaging, and more.
      </p>
